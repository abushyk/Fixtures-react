...
export default function App() {
    ...
    const [globalData, setGlobalData] = useState(globs);
    ...
    const getFixturesByTour = (tour) => {
        return globalData.fixtures.filter((item) => item[0] <= tour)
    }

    const createFixtureTable = (fixtures) => {
        return _createFixtureTable(fixtures, globalData.teamIndex)
    }

    const _createFixtureTable = (fixtures, teamNames) => {
        let result = [];
        for (let fixture of fixtures) {
            let t1id = fixture[1];
            let t2id = fixture[2];
                ...
                {<Row>
                    ...
                    <Col md={8}>
                        <ResultTable
                            ...
                            helper={{createFixtureTable: createFixtureTable, getFixturesByTour: getFixturesByTour}}
                        />
                    </Col>
                </Row>}
            </Container>
